...
<form class="formulario" method="post" action="/crear-cuenta">
    ...
    <div class="campo">
        ...
        <input type="text" id="telefono" name="telefono" placeholder="Tu Teléfono" value=<?php echo s($usuario->telefono) ?>>
    </div>

    <div class="campo">
        <label class=telefono">E-mail</label>
...
<div class="acciones">
    <a href="/" class="">¿Ya tienes una cuenta? Inicia Sesión</a>
